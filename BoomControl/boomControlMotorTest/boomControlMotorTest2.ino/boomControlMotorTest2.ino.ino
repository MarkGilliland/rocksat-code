...
#define DIRECTION 1 // 1 signifies out, 0 signifies in, on camera boom.
#define COMMS_EXTENSION_TIME 9000
#define CAMERA_EXTENSION_TIME 36000
#define TIMER COMMS_EXTENSION_TIME // 1.25" per sec, ~36sec for full extension on camera boom.
